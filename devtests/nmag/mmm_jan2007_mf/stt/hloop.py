...
dyfe2_yfe2_dyfe2 = DyFe2_YFe2_DyFe2("hloop", 1.0, norm_factor=0.001e12, P=1.0)
...
sim.set_current_density([1.0e13, 0.0, 0.0], unit=SI("A/m^2"))

sim.hysteresis(Hs,
               save=[('averages', at('stage_end'))],
	       do=[('next_stage', at('stage_time', SI(20e-12, "s")))])
