...
\begin{figure}[!p]
\lstinputlisting[linerange=1-41]{spacevarying.py}
\caption{Part 1.}
\end{figure}

\begin{figure}[!p]
\lstinputlisting[linerange=42-84,firstnumber=42]{spacevarying.py}
\caption{Part 2.}
\end{figure}

\begin{figure}[!p]
\lstinputlisting[linerange=85-126,firstnumber=85]{spacevarying.py}
\caption{Part 3.}
\end{figure}
