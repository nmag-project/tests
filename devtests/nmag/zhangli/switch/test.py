# Derived from the bigbar example
import time
import nmag
...
meshfile = "mesh/l040.nmesh.h5"

sim.load_mesh(meshfile, [("Py1", mat_Py), ("Py2", mat_Py)],unit_length=SI(1e-9,"m"))
...
def out(line, header=False, file="test_timings.log"):
    import os
...
date = time.asctime()
rev = "$Revision: 5467 $"[11:-2] #This file's version
import nsim
